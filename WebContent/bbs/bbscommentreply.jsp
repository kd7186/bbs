								...
								<table class="table table-striped" style="text-align:center; border: 1px solid #dddddd">
									...
									<tbody>
										...
										<tr style="display:none;">
											<td><textarea style="width: 640px; height: 30px;" name="commentTextReply"></textarea></td>
											<td><input type="button" style="width: 50px; height: 30px; background-color : #ffffff" class="btn-primary pull" value="등록" id="btnCommentReply"></td>
										</tr>
										<tr>
