...
<body>
	...
	<form action="bbsinsertprocess.do" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				<td><input type="text" name="title" placeholder="제목을 입력하세요" required id = "title" />
				</td>
			</tr>
			<tr>
				<td colspan="2"><textarea rows="12" cols="50" placeholder="내용을 입력하세요" name="content" required></textarea></td>
			</tr>
			<tr>
