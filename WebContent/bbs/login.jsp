...
<title>로그인</title>
 ...
 <style>
 	...
 	.login {background-color: #000000; color: white; border: 0; border-radius: 5px; padding: 10px 50px;}
 	#signup {background-color: #5e5e5e; color: white; border: 0; border-radius: 5px; padding: 10px 50px;}
 	...
 	#ipw{position : absolute; top: 250px; margin:0 640px;}
 	...
 	<body>
 		...
 		<div class = "container">
 			...
 			<table class="table table-striped" style="text-align:left;">
				...
				<hr/><br/>
				<form action ="login-process.do" method="post" align="center">
				...
				<hr/>
				<p align="center"><a href="join.do"><input type="button" value="회원가입" id="signup"/></a></p>
 		</div>
 	</body>
