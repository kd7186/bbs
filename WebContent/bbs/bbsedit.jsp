...
<body>
	...
	<div id="wriTitle"><b>글 수정</b></div>
	<form action="bbsupdateprocess.do" method="post">
		<input type="hidden" name="bbsNo" value="${bbs.bbsNo }">
		<table>
			<tr>
				<td><input type="text" name="title" value="${ bbs.bbsTitle }" required id = "title" />
				</td>
			</tr>
			<tr>
				<td colspan="2"><textarea rows="12" cols="50" name="content" required>${ bbs.bbsContent }</textarea></td>
			</tr>
			<tr>
